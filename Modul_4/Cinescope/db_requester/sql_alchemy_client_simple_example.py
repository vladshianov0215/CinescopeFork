...
#============================================================
# простой пример запроса в базу данных с использованием SQL
#============================================================
# SQL-запрос
def sdl_alchemy_SQL():
    query = """
...
#============================================================
# тот же пример но с использованием SQLAlchemy
#============================================================
def sdl_alchemy_ORM():
...
def main():# раскоментировав различные функции вы можете запустить и увидеть вывод в лог 
    print("============================================================\n"+
          "простой пример запроса в базу данных с использованием SQL\n" +
          "============================================================\n")
    sdl_alchemy_SQL()
    ...
    print("============================================================\n"+
          "простой пример запроса в базу данных с использованием ORM\n" +
          "============================================================\n")
    sdl_alchemy_ORM()
